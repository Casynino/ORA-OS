...
export default async function WarehouseReturnsPage() {
  ...
  return (
    <div className="space-y-6">
      <PageHeader
        title="Returns"
        description="Confirm receipt of authorised returns to reconcile stock into the warehouse. Each decision is logged."
      />
      <ReturnsManager returns={dto} detailBase="/warehouse/returns" />
    </div>
  );
}
